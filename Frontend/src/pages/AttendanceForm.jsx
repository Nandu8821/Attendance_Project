...
//     if (!email || !officeData.some((user) => user.email === email)) {
...
//     if (
//       formData.email &&
//       officeData.some((user) => user.email === formData.email)
//     ) {
...
//     const user = officeData.find((u) => u.email === email);
//     if (user) {
//       setFormData((prev) => ({
//         ...prev,
//         email: user.email,
...
//           alert("Unable to fetch your location. Please enable geolocation.");
//           setFormData((prev) => ({
//             ...prev,
...
//     if (!officeData.some((user) => user.email === formData.email)) {
...
//       alert("Error submitting attendance. Please check your connection.");
//     }
//   };
